...
```php
composer require simpleminds/laravel-friendships
```

If you are using Laravel < 5.5, you need to add Simpleminds\Friendships\FriendshipsServiceProvider to your `config/app.php` providers array:
```php
Simpleminds\Friendships\FriendshipsServiceProvider::class,
```
Publish config and migrations
```
php artisan vendor:publish --provider="Simpleminds\Friendships\FriendshipsServiceProvider"
```
...
## Setup a Model
```php
use Simpleminds\Friendships\Traits\Friendable;
...
## How to use
[Check the Test file to see the package in action](https://github.com/simpleminds/laravel-friendships/blob/master/tests/FriendshipsTest.php)
